      ...
      <div className={style.display_grid_container}>
        <div className={style.display_grid}>
          <Photo
            ...
            name="lorem Ipsum"
          />
          <Photo src={p2} by="Del Drake" dep="SY InD" name="lorem Ipsum" />
          <Photo src={p3} by="Howard Mathews" dep="FY InD" name="lorem Ipsum" />
          <Photo
            src={p4}
            by="Beatrice Johnson"
            dep="SY InD"
            name="lorem Ipsum"
          />
          <Photo src={p5} by="Sonny Stevens" dep="TY InD" name="lorem Ipsum" />
          <Photo src={p6} by="Tyler Lucero" dep="FNY InD" name="lorem Ipsum" />
          <Photo src={p7} by="Cedric Mooney" dep="TY InD" name="lorem Ipsum" />
          <Photo
            src={p8}
            by="Sharlene Huffman"
            dep="FNY InD"
